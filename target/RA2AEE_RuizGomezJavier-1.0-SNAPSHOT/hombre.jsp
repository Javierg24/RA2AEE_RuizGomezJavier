<%-- 
    Document   : Hombre
    Created on : 25 oct 2024, 12:07:26
    Author     : DAW2
--%>
...
<body>
    <div class="container">
        ...
        <p>Explora nuestra colección de ropa para hombres, diseñada para la comodidad y el estilo.</p>

        <div class="product-grid">
            <!-- Producto 1 -->
            <div class="product-item">
                <img src="imagenes/1.png" alt="Camisa de hombre clásica" class="product-img">
            ...
            <!-- Producto 2 -->
            <div class="product-item">
                <img src="imagenes/1.png" alt="Pantalón de hombre casual" class="product-img">
            ...
            <!-- Producto 3 -->
            <div class="product-item">
                <img src="imagenes/1.png" alt="Chaqueta de hombre" class="product-img">
            ...
            <!-- Producto 4 -->
            <div class="product-item">
                <img src="imagenes/1.png" alt="Zapatos de hombre" class="product-img">
